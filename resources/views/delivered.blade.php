...
<div class="info-profile purchase-order__products">
    <ul class="__header purchase-order__header">
        ...
        <li class="__header-item delivered active">
            <a href="">
                Delivered
            </a>
        </li>
    ...
    <ul class="list-products__order">
        ...
        <li class="__order-item">
            ...
            <a href="{{$url_web}}/user/purchase/order/detail_shipping?customer={{$sp['user_id']}}&status=Delivered&shipping={{$sp['shipping_tracking_id']}}">
